...
powershell -ExecutionPolicy Bypass -Command "Start-Process PowerShell -Verb RunAs -NoExit -WorkingDirectory %~dp0_scriptFiles -ArgumentList '-file %~dp0_scriptFiles\_SQLExpressInstall.1.ps1'"
