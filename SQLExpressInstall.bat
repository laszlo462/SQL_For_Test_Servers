...
powershell -ExecutionPolicy Bypass -Noexit -Command "Start-Process PowerShell -Verb RunAs -WorkingDirectory %~dp0_scriptFiles -ArgumentList '-file %~dp0_scriptFiles\_SQLExpressInstall.1.ps1'"
